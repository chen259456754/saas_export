    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/cargo/contractProduct/edit.do" method="post" enctype="multipart/form-data">
                <input type="text" name="id" value="${contractProduct.id}" hidden>
                <input type="text" name="contractId" value="${contractProduct.contractId}" hidden>
                <input type="text"  name="factoryName" id="factoryName" value="${contractProduct.factoryName}" hidden>
